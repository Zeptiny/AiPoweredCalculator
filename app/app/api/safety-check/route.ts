...
import { CATEGORY_DESCRIPTIONS, SAFETY_CATEGORIES } from '@/lib/safety';
import type { SafetyClassification, SafetyConversationContext } from '@/lib/types';
...
async function classifyContentSafety(
  ...
  role: 'User' | 'Agent',
  apiKey: string,
  conversationContext?: SafetyConversationContext
